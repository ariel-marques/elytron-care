const commentsData = [
    ...
    { name: "Darius Walker", comment: "I can sit at the table with my grandkids and not stress about a thing.", gender: "male", ageGroup: "young" },
    { name: "Ashley Miller", comment: "Meals with my grandkids are happy again, no more fear.", gender: "female", ageGroup: "young" },
    ...
    { name: "Jonathan Marsh", comment: "I don’t have to worry anymore when sharing meals with my grandkids.", gender: "male", ageGroup: "young" },
    ...
    { name: "Dylan Lyons", comment: "I’m able to savor meals with my grandkids without any anxiety now.", gender: "male", ageGroup: "young" },
    ...
    { name: "Kathleen Wong", comment: "It’s so freeing to enjoy a meal with my grandkids without fear.", gender: "female", ageGroup: "young" },
    ...
    { name: "Matthew Carrillo", comment: "I finally get to enjoy every meal with my grandkids like I should.", gender: "male", ageGroup: "young" },
    ...
    { name: "Andrew Francis", comment: "Mealtime with my grandkids used to be stressful, now it’s just pure joy.", gender: "male", ageGroup: "young" },
];